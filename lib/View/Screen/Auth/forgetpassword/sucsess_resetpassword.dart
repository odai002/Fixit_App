...
class SucsessResetpassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    SucsessResettpasswordControllerImp controller = Get.put(SucsessResettpasswordControllerImp());
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.check_circle_rounded,color: const Color(0xff6A3BA8),size:200,),
            Padding(
