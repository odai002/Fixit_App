...
class ContractPageHomeOwner extends StatelessWidget {
  ContractPageHomeOwner({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<ContractControllerHomeOwner>(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              const SizedBox(width: 12),
                              Text("${controller.contract!.price}")
                            ],
                          ),
                        ),
                        const SizedBox(height: 33),
                        ...
                        if (controller.contract!.status == null)
                          Row(
